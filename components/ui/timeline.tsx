...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "absolute left-[6px] top-[5px] h-full w-px -translate-x-1/2 translate-y-2 bg-primary",
      className,
    )}
    {...props}
  />
...
>(({ className, icon, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "flex size-3 flex-col items-center justify-center rounded-full bg-primary",
      className,
    )}
    {...props}
  >
